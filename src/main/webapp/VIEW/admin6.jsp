            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form method="POST" class="my-login-validation" novalidate=""
                                              action="/final_database_war_exploded/addMajorServlet">
                                            <div class="form-group">
                                                <label for="Mno">专业编号：</label>
                                                <input id="Mno" type="text" class="form-control" name="Mno">
                                            </div>
                                            <div class="form-group">
                                                <label for="Mname">专业名称：</label>
                                                <input id="Mname" type="text" class="form-control" name="Mname">
                                            </div>
                                            <div class="form-group">
                                                <label for="Collegeno">所属学院：</label>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">专业信息查询</h3>
                                <form method="POST" class="my-login-validation" novalidate=""
                                      action="/final_database_war_exploded/queryMajorServlet">
                                    <div style="text-align: center">
                                        <button class="btn btn-info" type="submit">
                                            查询
                                        </button>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach var="maj" items="${majlist}">
                                            <tr>
                                                <td><c:out value="${maj.mno}"/></td>
                                                <td><c:out value="${maj.mname}"/></td>
                                                <td><c:out value="${maj.collegeno}"/></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
