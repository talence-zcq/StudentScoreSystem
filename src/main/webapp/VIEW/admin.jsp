            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form method="POST" class="my-login-validation" novalidate=""
                                              action="/final_database_war_exploded/addStudentServlet">
                                            <div class="form-group">
                                                <label for="Sno">学号：</label>
                                                <input id="Sno" type="text" class="form-control" name="Sno" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Mno">专业：</label>
                                                <input id="Mno" type="text" class="form-control" name="Mno" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Sname">姓名：</label>
                                                <input id="Sname" type="text" class="form-control" name="Sname"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="Sage" type="number" class="form-control" name="Sage"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Savggpa">平均绩点：</label>
                                                <input id="Savggpa" type="number" class="form-control" name="Savggpa"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Scredit">已修学分：</label>
                                                <input id="Scredit" type="number" class="form-control" name="Scredit"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Sphone">联系电话：</label>
                                                <input id="Sphone" type="text" class="form-control" name="Sphone"
                                                       value="" maxlength="11">
                                            </div>
                                            <div class="form-group">
                                                <label for="Shometown">生源地：</label>
                                                <input id="Shometown" type="text" class="form-control" name="Shometown"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Spwd">登录密码：</label>
                                                <input id="Spwd" type="text" class="form-control" name="Spwd">
                                            </div>
                                            <div class="form-group">
                                                <label for="Classno">班级编号：</label>
                                                <input id="Classno" type="text" class="form-control" name="Classno">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">学生信息查询</h3>
                                <form method="POST" class="my-login-validation" novalidate=""
                                      action="/final_database_war_exploded/queryStudentServlet">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-4">
                                        <label>专业：</label>
                                        <input type="text" class="form-control" name="Mno" value="">
                                    </div>
                                    <div class="form-group col-xs-12 col-sm-4">
                                        <label>班级：</label>
                                    ...
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="stu" items="${stulist}">
                                            <tr>
                                                ...
                                                <td><c:out value="${stu.major}"/></td>
                                                <td><c:out value="${stu.sname}"/></td>
                                                <td><c:out value="${stu.ssex}"/></td>
                                                <td><c:out value="${stu.banji}"/></td>
                                                <td><c:out value="${stu.sphone}"/></td>
                                                <td><c:out value="${stu.shometown}"/></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
