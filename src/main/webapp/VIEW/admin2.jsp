            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form method="POST" class="my-login-validation" novalidate=""
                                              action="/final_database_war_exploded/addCourseServlet">
                                            <div class="form-group">
                                                <label for="Courseno">课程编号：</label>
                                                <input id="Courseno" type="text" class="form-control" name="Courseno" value="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="Collegeno">开设学院：</label>
                                                <input id="Collegeno" type="text" class="form-control" name="Collegeno"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Ccredit">课程学分：</label>
                                                <input id="Ccredit" type="number" class="form-control" name="Ccredit"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Chours">课程学时：</label>
                                                <input id="Chours" type="number" class="form-control" name="Chours"
                                                       value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Cassessment">考核方式：</label>
                                                <select id="Cassessment" class="form-control" name="Cassessment">
                                                    <option value="考查" selected="selected">考查</option>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">课程信息查询</h3>
                                <form method="POST" class="my-login-validation" novalidate=""
                                action="/final_database_war_exploded/queryCourseServlet">
                                    <div class="form-group col-xs-12 col-sm-4">
                                        <label>课程编号：</label>
                                        <input type="text" class="form-control" name="Courseno" value="">
                                    </div>
                                    <div class="form-group col-xs-12 col-sm-4">
                                        <label>开设学院：</label>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="cou" items="${coulist}">
                                            <tr>
                                                <td><c:out value="${cou.courseno}"/></td>
                                                <td><c:out value="${cou.coursename}"/></td>
                                                <td><c:out value="${cou.ccredit}"/></td>
                                                <td><c:out value="${cou.cterm}"/></td>
                                                <td><c:out value="${cou.tname}"/></td>
                                                <td><c:out value="${cou.collegename}"/></td>
                                                <td><c:out value="${cou.cassessment}"/></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
