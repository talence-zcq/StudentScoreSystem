            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form method="POST" class="my-login-validation" novalidate=""
                                              action="/final_database_war_exploded/addCollegeServlet">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="Collegename" type="text" class="form-control" name="Collegename">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">学院信息查询</h3>
                                <form method="POST" class="my-login-validation" novalidate=""
                                      action="/final_database_war_exploded/queryCollegeServlet">
                                    <div style="text-align: center">
                                        <button class="btn btn-info" type="submit">
                                            查询
                                        </button>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="col" items="${collist}">
                                            <tr>
                                                <td><c:out value="${col.collegeno}"/></td>
                                                <td><c:out value="${col.collegename}"/></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
