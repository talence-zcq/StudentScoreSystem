                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form method="POST" class="my-login-validation" novalidate=""
                                      action="/final_database_war_exploded/queryGradeServlet">
                                    <div style="text-align: center">
                                        ...
                                        <div class="form-group col-xs-12 col-sm-6">
                                            <label>上课学期：</label>
                                            <input type="text" class="form-control" name="cterm" value="">
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach var="gra" items="${gralist}">
                                            <tr>
            ...
            series: [
                {
                    ...
                    data: [
                        {value: <c:out value="${nine}"/>, name: '90-100'},
                        {value:<c:out value="${eight}"/>, name: '80-90'},
                        {value: <c:out value="${seven}"/>, name: '70-80'},
                        {value: <c:out value="${six}"/>, name: '60-70'},
                        {value: <c:out value="${down}"/>, name: '不及格'}
                    ]
                }
            ]
        };
