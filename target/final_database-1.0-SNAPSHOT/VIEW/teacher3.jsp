                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form method="POST" class="my-login-validation" novalidate=""
                              action="/final_database_war_exploded/modifyPwdServlet">
                            <div class="form-group">
                                <label for="old_pwd">原密码：</label>
                                <input id="old_pwd" type="text" class="form-control" name="old_pwd">
                            </div>
                            <div class="form-group">
                                <label for="new_pwd">新密码：</label>
                                <input id="new_pwd" type="text" class="form-control" name="new_pwd">
                            </div>
