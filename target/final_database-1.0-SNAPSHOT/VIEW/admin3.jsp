            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form method="POST" class="my-login-validation" novalidate=""
                                              action="/final_database_war_exploded/addSetupinfoServlet">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="Classno" type="text" class="form-control" name="Classno" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Tno">任教教师编号：</label>
                                                <input id="Tno" type="text" class="form-control" name="Tno" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Cterm">开设学期：</label>
                                                <input id="Cterm" type="text" class="form-control" name="Cterm" value="">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">开设信息查询</h3>
                                <form method="POST" class="my-login-validation" novalidate=""
                                      action="/final_database_war_exploded/querySetupServlet">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="set" items="${setlist}">
                                            <tr>
                                                <td><c:out value="${set.coursename}"/></td>
                                                <td><c:out value="${set.classname}"/></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
